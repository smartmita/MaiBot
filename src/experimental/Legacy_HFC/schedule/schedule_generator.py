...
class ScheduleGenerator:
    ...
    def construct_schedule_refinement_prompt(self, initial_schedule: str, knowledge_and_memory: str) -> str:
        ...
        prompt = (
            ...
            f"2. 将知识库和记忆中的相关情节、人物、地点、特定行为或思考方式自然地融入到日程的描述中。\n"
            f"3. 如果初步日程中的某些活动与知识库/记忆有冲突，请以知识库/记忆为准进行修正。\n"
            ...
            f"8. 如果你认为初步日程已经很好地结合了所提供的知识库和记忆，或者知识库和记忆与日程内容关联不大，可以只做微小调整或不作调整。但在这种情况下，也请尽量确保日程中没有与知识库/记忆明显矛盾的地方。\n\n"
            f"修改后的日程安排："
        )
        return prompt
